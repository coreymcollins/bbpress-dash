<?php
/**
 * BbPress_Dash Test Bootstrapper.
 *
 * @since   1.0.0
 ...
 * @since 1.0.0
 */
function _manually_load_bbpress_dash_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/bbpress-dash.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_bbpress_dash_plugin' );
